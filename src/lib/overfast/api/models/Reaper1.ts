...
/**
 * Check if a given object implements the Reaper1 interface.
 */
export function instanceOfReaper1(value: object): boolean {
	let isInstance = true;
...
export function Reaper1FromJSON(json: any): Reaper1 {
	return Reaper1FromJSONTyped(json, false);
}

export function Reaper1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Reaper1 {
...
export function Reaper1ToJSON(value?: Reaper1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
