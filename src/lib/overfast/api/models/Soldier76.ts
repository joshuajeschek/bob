...
/**
 * Check if a given object implements the Soldier76 interface.
 */
export function instanceOfSoldier76(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function Soldier76FromJSON(json: any): Soldier76 {
	return Soldier76FromJSONTyped(json, false);
}

export function Soldier76FromJSONTyped(json: any, ignoreDiscriminator: boolean): Soldier76 {
...
export function Soldier76ToJSON(value?: Soldier76 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
