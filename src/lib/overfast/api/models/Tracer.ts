...
/**
 * Check if a given object implements the Tracer interface.
 */
export function instanceOfTracer(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function TracerFromJSON(json: any): Tracer {
	return TracerFromJSONTyped(json, false);
}

export function TracerFromJSONTyped(json: any, ignoreDiscriminator: boolean): Tracer {
...
export function TracerToJSON(value?: Tracer | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
