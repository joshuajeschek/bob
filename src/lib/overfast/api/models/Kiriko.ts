...
/**
 * Check if a given object implements the Kiriko interface.
 */
export function instanceOfKiriko(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function KirikoFromJSON(json: any): Kiriko {
	return KirikoFromJSONTyped(json, false);
}

export function KirikoFromJSONTyped(json: any, ignoreDiscriminator: boolean): Kiriko {
...
export function KirikoToJSON(value?: Kiriko | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
