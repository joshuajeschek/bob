...
/**
 * Check if a given object implements the Kiriko1 interface.
 */
export function instanceOfKiriko1(value: object): boolean {
	let isInstance = true;
...
export function Kiriko1FromJSON(json: any): Kiriko1 {
	return Kiriko1FromJSONTyped(json, false);
}

export function Kiriko1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Kiriko1 {
...
export function Kiriko1ToJSON(value?: Kiriko1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
