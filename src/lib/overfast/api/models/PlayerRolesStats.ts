 ...
 *
 * @export
 * @interface PlayerRolesStats
 */
export interface PlayerRolesStats {
	/**
	 *
	 * @type {Tank1}
	 * @memberof PlayerRolesStats
	 */
	tank?: Tank1;
	/**
	 *
...
/**
 * Check if a given object implements the PlayerRolesStats interface.
 */
export function instanceOfPlayerRolesStats(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function PlayerRolesStatsFromJSON(json: any): PlayerRolesStats {
	return PlayerRolesStatsFromJSONTyped(json, false);
}

export function PlayerRolesStatsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerRolesStats {
...
export function PlayerRolesStatsToJSON(value?: PlayerRolesStats | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
