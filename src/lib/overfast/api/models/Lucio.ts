...
/**
 * Check if a given object implements the Lucio interface.
 */
export function instanceOfLucio(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function LucioFromJSON(json: any): Lucio {
	return LucioFromJSONTyped(json, false);
}

export function LucioFromJSONTyped(json: any, ignoreDiscriminator: boolean): Lucio {
...
export function LucioToJSON(value?: Lucio | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
