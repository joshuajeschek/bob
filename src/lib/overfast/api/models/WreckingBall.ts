 ...
 * @export
 * @interface WreckingBall
 */
export interface WreckingBall {
	/**
	 * Statistics for "Assists" category
	 * @type {{ [key: string]: Assists; }}
	 * @memberof WreckingBall
	 */
...
/**
 * Check if a given object implements the WreckingBall interface.
 */
export function instanceOfWreckingBall(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function WreckingBallFromJSON(json: any): WreckingBall {
	return WreckingBallFromJSONTyped(json, false);
}

export function WreckingBallFromJSONTyped(json: any, ignoreDiscriminator: boolean): WreckingBall {
...
export function WreckingBallToJSON(value?: WreckingBall | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
