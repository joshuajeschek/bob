...
/**
 * Check if a given object implements the Sigma interface.
 */
export function instanceOfSigma(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function SigmaFromJSON(json: any): Sigma {
	return SigmaFromJSONTyped(json, false);
}

export function SigmaFromJSONTyped(json: any, ignoreDiscriminator: boolean): Sigma {
...
export function SigmaToJSON(value?: Sigma | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
