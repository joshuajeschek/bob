...
export type MapGamemode = (typeof MapGamemode)[keyof typeof MapGamemode];

export function MapGamemodeFromJSON(json: any): MapGamemode {
	return MapGamemodeFromJSONTyped(json, false);
}

export function MapGamemodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): MapGamemode {
	return json as MapGamemode;
}

export function MapGamemodeToJSON(value?: MapGamemode | null): any {
	return value as any;
}
