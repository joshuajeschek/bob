...
/**
 * Check if a given object implements the Torbjorn interface.
 */
export function instanceOfTorbjorn(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function TorbjornFromJSON(json: any): Torbjorn {
	return TorbjornFromJSONTyped(json, false);
}

export function TorbjornFromJSONTyped(json: any, ignoreDiscriminator: boolean): Torbjorn {
...
export function TorbjornToJSON(value?: Torbjorn | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
