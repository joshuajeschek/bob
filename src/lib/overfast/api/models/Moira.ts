...
/**
 * Check if a given object implements the Moira interface.
 */
export function instanceOfMoira(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function MoiraFromJSON(json: any): Moira {
	return MoiraFromJSONTyped(json, false);
}

export function MoiraFromJSONTyped(json: any, ignoreDiscriminator: boolean): Moira {
...
export function MoiraToJSON(value?: Moira | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
