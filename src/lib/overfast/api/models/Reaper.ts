...
/**
 * Check if a given object implements the Reaper interface.
 */
export function instanceOfReaper(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function ReaperFromJSON(json: any): Reaper {
	return ReaperFromJSONTyped(json, false);
}

export function ReaperFromJSONTyped(json: any, ignoreDiscriminator: boolean): Reaper {
...
export function ReaperToJSON(value?: Reaper | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
