...
/**
 * Check if a given object implements the Zenyatta interface.
 */
export function instanceOfZenyatta(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function ZenyattaFromJSON(json: any): Zenyatta {
	return ZenyattaFromJSONTyped(json, false);
}

export function ZenyattaFromJSONTyped(json: any, ignoreDiscriminator: boolean): Zenyatta {
...
export function ZenyattaToJSON(value?: Zenyatta | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
