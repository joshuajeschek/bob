...
/**
 * Check if a given object implements the HeroPlayerCareerStats interface.
 */
export function instanceOfHeroPlayerCareerStats(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function HeroPlayerCareerStatsFromJSON(json: any): HeroPlayerCareerStats {
	return HeroPlayerCareerStatsFromJSONTyped(json, false);
}

export function HeroPlayerCareerStatsFromJSONTyped(json: any, ignoreDiscriminator: boolean): HeroPlayerCareerStats {
...
export function HeroPlayerCareerStatsToJSON(value?: HeroPlayerCareerStats | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
