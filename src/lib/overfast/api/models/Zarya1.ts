...
/**
 * Check if a given object implements the Zarya1 interface.
 */
export function instanceOfZarya1(value: object): boolean {
	let isInstance = true;
...
export function Zarya1FromJSON(json: any): Zarya1 {
	return Zarya1FromJSONTyped(json, false);
}

export function Zarya1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Zarya1 {
...
export function Zarya1ToJSON(value?: Zarya1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
