...
/**
 * Check if a given object implements the Ramattra1 interface.
 */
export function instanceOfRamattra1(value: object): boolean {
	let isInstance = true;
...
export function Ramattra1FromJSON(json: any): Ramattra1 {
	return Ramattra1FromJSONTyped(json, false);
}

export function Ramattra1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Ramattra1 {
...
export function Ramattra1ToJSON(value?: Ramattra1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
