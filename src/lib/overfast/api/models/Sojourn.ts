...
/**
 * Check if a given object implements the Sojourn interface.
 */
export function instanceOfSojourn(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function SojournFromJSON(json: any): Sojourn {
	return SojournFromJSONTyped(json, false);
}

export function SojournFromJSONTyped(json: any, ignoreDiscriminator: boolean): Sojourn {
...
export function SojournToJSON(value?: Sojourn | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
