...
/**
 * Check if a given object implements the Junkrat1 interface.
 */
export function instanceOfJunkrat1(value: object): boolean {
	let isInstance = true;
...
export function Junkrat1FromJSON(json: any): Junkrat1 {
	return Junkrat1FromJSONTyped(json, false);
}

export function Junkrat1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Junkrat1 {
...
export function Junkrat1ToJSON(value?: Junkrat1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
