...
/**
 * Check if a given object implements the Hanzo interface.
 */
export function instanceOfHanzo(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function HanzoFromJSON(json: any): Hanzo {
	return HanzoFromJSONTyped(json, false);
}

export function HanzoFromJSONTyped(json: any, ignoreDiscriminator: boolean): Hanzo {
...
export function HanzoToJSON(value?: Hanzo | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
