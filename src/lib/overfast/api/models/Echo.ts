...
/**
 * Check if a given object implements the Echo interface.
 */
export function instanceOfEcho(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function EchoFromJSON(json: any): Echo {
	return EchoFromJSONTyped(json, false);
}

export function EchoFromJSONTyped(json: any, ignoreDiscriminator: boolean): Echo {
...
export function EchoToJSON(value?: Echo | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
