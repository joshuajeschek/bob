...
/**
 * Check if a given object implements the Pharah1 interface.
 */
export function instanceOfPharah1(value: object): boolean {
	let isInstance = true;
...
export function Pharah1FromJSON(json: any): Pharah1 {
	return Pharah1FromJSONTyped(json, false);
}

export function Pharah1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Pharah1 {
...
export function Pharah1ToJSON(value?: Pharah1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
