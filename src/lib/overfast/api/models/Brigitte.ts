...
/**
 * Check if a given object implements the Brigitte interface.
 */
export function instanceOfBrigitte(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function BrigitteFromJSON(json: any): Brigitte {
	return BrigitteFromJSONTyped(json, false);
}

export function BrigitteFromJSONTyped(json: any, ignoreDiscriminator: boolean): Brigitte {
...
export function BrigitteToJSON(value?: Brigitte | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
