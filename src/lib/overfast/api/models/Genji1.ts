...
/**
 * Check if a given object implements the Genji1 interface.
 */
export function instanceOfGenji1(value: object): boolean {
	let isInstance = true;
...
export function Genji1FromJSON(json: any): Genji1 {
	return Genji1FromJSONTyped(json, false);
}

export function Genji1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Genji1 {
...
export function Genji1ToJSON(value?: Genji1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
