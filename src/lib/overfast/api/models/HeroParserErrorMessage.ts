 ...
 *
 * @export
 * @interface HeroParserErrorMessage
 */
export interface HeroParserErrorMessage {
	/**
	 * Message describing the hero parser error
	 * @type {string}
	 * @memberof HeroParserErrorMessage
	 */
	error: string;
}

/**
 * Check if a given object implements the HeroParserErrorMessage interface.
 */
export function instanceOfHeroParserErrorMessage(value: object): boolean {
	let isInstance = true;
...
export function HeroParserErrorMessageFromJSON(json: any): HeroParserErrorMessage {
	return HeroParserErrorMessageFromJSONTyped(json, false);
}

export function HeroParserErrorMessageFromJSONTyped(json: any, ignoreDiscriminator: boolean): HeroParserErrorMessage {
...
export function HeroParserErrorMessageToJSON(value?: HeroParserErrorMessage | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
