...
/**
 * Check if a given object implements the Ana interface.
 */
export function instanceOfAna(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function AnaFromJSON(json: any): Ana {
	return AnaFromJSONTyped(json, false);
}

export function AnaFromJSONTyped(json: any, ignoreDiscriminator: boolean): Ana {
...
export function AnaToJSON(value?: Ana | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
