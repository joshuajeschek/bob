...
/**
 * Check if a given object implements the Symmetra interface.
 */
export function instanceOfSymmetra(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function SymmetraFromJSON(json: any): Symmetra {
	return SymmetraFromJSONTyped(json, false);
}

export function SymmetraFromJSONTyped(json: any, ignoreDiscriminator: boolean): Symmetra {
...
export function SymmetraToJSON(value?: Symmetra | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
