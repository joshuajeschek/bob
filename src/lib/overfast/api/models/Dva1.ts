...
/**
 * Check if a given object implements the Dva1 interface.
 */
export function instanceOfDva1(value: object): boolean {
	let isInstance = true;
...
export function Dva1FromJSON(json: any): Dva1 {
	return Dva1FromJSONTyped(json, false);
}

export function Dva1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Dva1 {
...
export function Dva1ToJSON(value?: Dva1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
