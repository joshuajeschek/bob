...
/**
 * Check if a given object implements the Torbjorn1 interface.
 */
export function instanceOfTorbjorn1(value: object): boolean {
	let isInstance = true;
...
export function Torbjorn1FromJSON(json: any): Torbjorn1 {
	return Torbjorn1FromJSONTyped(json, false);
}

export function Torbjorn1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Torbjorn1 {
...
export function Torbjorn1ToJSON(value?: Torbjorn1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
