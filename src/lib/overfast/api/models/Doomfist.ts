...
/**
 * Check if a given object implements the Doomfist interface.
 */
export function instanceOfDoomfist(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function DoomfistFromJSON(json: any): Doomfist {
	return DoomfistFromJSONTyped(json, false);
}

export function DoomfistFromJSONTyped(json: any, ignoreDiscriminator: boolean): Doomfist {
...
export function DoomfistToJSON(value?: Doomfist | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
