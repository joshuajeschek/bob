...
/**
 * Check if a given object implements the Baptiste1 interface.
 */
export function instanceOfBaptiste1(value: object): boolean {
	let isInstance = true;
...
export function Baptiste1FromJSON(json: any): Baptiste1 {
	return Baptiste1FromJSONTyped(json, false);
}

export function Baptiste1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Baptiste1 {
...
export function Baptiste1ToJSON(value?: Baptiste1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
