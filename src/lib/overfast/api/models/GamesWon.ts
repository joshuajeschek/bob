...
/**
 * Check if a given object implements the GamesWon interface.
 */
export function instanceOfGamesWon(value: object): boolean {
	let isInstance = true;
...
export function GamesWonFromJSON(json: any): GamesWon {
	return GamesWonFromJSONTyped(json, false);
}

export function GamesWonFromJSONTyped(json: any, ignoreDiscriminator: boolean): GamesWon {
...
export function GamesWonToJSON(value?: GamesWon | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
