...
/**
 * Check if a given object implements the Sigma1 interface.
 */
export function instanceOfSigma1(value: object): boolean {
	let isInstance = true;
...
export function Sigma1FromJSON(json: any): Sigma1 {
	return Sigma1FromJSONTyped(json, false);
}

export function Sigma1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Sigma1 {
...
export function Sigma1ToJSON(value?: Sigma1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
