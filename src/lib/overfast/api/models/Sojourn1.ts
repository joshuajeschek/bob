...
/**
 * Check if a given object implements the Sojourn1 interface.
 */
export function instanceOfSojourn1(value: object): boolean {
	let isInstance = true;
...
export function Sojourn1FromJSON(json: any): Sojourn1 {
	return Sojourn1FromJSONTyped(json, false);
}

export function Sojourn1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Sojourn1 {
...
export function Sojourn1ToJSON(value?: Sojourn1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
