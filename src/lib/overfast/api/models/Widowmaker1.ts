 ...
 * @export
 * @interface Widowmaker1
 */
export interface Widowmaker1 {
	/**
	 * Number of games played
	 * @type {number}
	 * @memberof Widowmaker1
	 */
	gamesPlayed: number;
	/**
	 * Number of games won
...
/**
 * Check if a given object implements the Widowmaker1 interface.
 */
export function instanceOfWidowmaker1(value: object): boolean {
	let isInstance = true;
...
export function Widowmaker1FromJSON(json: any): Widowmaker1 {
	return Widowmaker1FromJSONTyped(json, false);
}

export function Widowmaker1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Widowmaker1 {
...
export function Widowmaker1ToJSON(value?: Widowmaker1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
