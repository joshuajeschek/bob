 ...
 * @export
 * @interface Reinhardt1
 */
export interface Reinhardt1 {
	/**
...
/**
 * Check if a given object implements the Reinhardt1 interface.
 */
export function instanceOfReinhardt1(value: object): boolean {
	let isInstance = true;
...
export function Reinhardt1FromJSON(json: any): Reinhardt1 {
	return Reinhardt1FromJSONTyped(json, false);
}

export function Reinhardt1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Reinhardt1 {
...
export function Reinhardt1ToJSON(value?: Reinhardt1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
