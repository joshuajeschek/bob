...
/**
 * Check if a given object implements the Mercy1 interface.
 */
export function instanceOfMercy1(value: object): boolean {
	let isInstance = true;
...
export function Mercy1FromJSON(json: any): Mercy1 {
	return Mercy1FromJSONTyped(json, false);
}

export function Mercy1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Mercy1 {
...
export function Mercy1ToJSON(value?: Mercy1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
