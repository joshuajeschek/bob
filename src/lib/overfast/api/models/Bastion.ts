...
/**
 * Check if a given object implements the Bastion interface.
 */
export function instanceOfBastion(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function BastionFromJSON(json: any): Bastion {
	return BastionFromJSONTyped(json, false);
}

export function BastionFromJSONTyped(json: any, ignoreDiscriminator: boolean): Bastion {
...
export function BastionToJSON(value?: Bastion | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
