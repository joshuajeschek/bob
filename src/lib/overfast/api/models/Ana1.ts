...
/**
 * Check if a given object implements the Ana1 interface.
 */
export function instanceOfAna1(value: object): boolean {
	let isInstance = true;
...
export function Ana1FromJSON(json: any): Ana1 {
	return Ana1FromJSONTyped(json, false);
}

export function Ana1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Ana1 {
...
export function Ana1ToJSON(value?: Ana1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
