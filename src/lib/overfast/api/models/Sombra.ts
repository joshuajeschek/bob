...
/**
 * Check if a given object implements the Sombra interface.
 */
export function instanceOfSombra(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function SombraFromJSON(json: any): Sombra {
	return SombraFromJSONTyped(json, false);
}

export function SombraFromJSONTyped(json: any, ignoreDiscriminator: boolean): Sombra {
...
export function SombraToJSON(value?: Sombra | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
