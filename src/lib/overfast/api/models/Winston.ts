...
/**
 * Check if a given object implements the Winston interface.
 */
export function instanceOfWinston(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function WinstonFromJSON(json: any): Winston {
	return WinstonFromJSONTyped(json, false);
}

export function WinstonFromJSONTyped(json: any, ignoreDiscriminator: boolean): Winston {
...
export function WinstonToJSON(value?: Winston | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
