...
/**
 * Check if a given object implements the Sombra1 interface.
 */
export function instanceOfSombra1(value: object): boolean {
	let isInstance = true;
...
export function Sombra1FromJSON(json: any): Sombra1 {
	return Sombra1FromJSONTyped(json, false);
}

export function Sombra1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Sombra1 {
...
export function Sombra1ToJSON(value?: Sombra1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
