...
/**
 * Check if a given object implements the Hanzo1 interface.
 */
export function instanceOfHanzo1(value: object): boolean {
	let isInstance = true;
...
export function Hanzo1FromJSON(json: any): Hanzo1 {
	return Hanzo1FromJSONTyped(json, false);
}

export function Hanzo1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Hanzo1 {
...
export function Hanzo1ToJSON(value?: Hanzo1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
