...
/**
 * Check if a given object implements the Console1 interface.
 */
export function instanceOfConsole1(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function Console1FromJSON(json: any): Console1 {
	return Console1FromJSONTyped(json, false);
}

export function Console1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Console1 {
...
export function Console1ToJSON(value?: Console1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
