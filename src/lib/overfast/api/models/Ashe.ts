...
/**
 * Check if a given object implements the Ashe interface.
 */
export function instanceOfAshe(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function AsheFromJSON(json: any): Ashe {
	return AsheFromJSONTyped(json, false);
}

export function AsheFromJSONTyped(json: any, ignoreDiscriminator: boolean): Ashe {
...
export function AsheToJSON(value?: Ashe | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
