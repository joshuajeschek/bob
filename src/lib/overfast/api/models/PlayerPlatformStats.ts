 ...
 *
 * @export
 * @interface PlayerPlatformStats
 */
export interface PlayerPlatformStats {
	/**
	 *
	 * @type {Quickplay}
	 * @memberof PlayerPlatformStats
	 */
	quickplay?: Quickplay;
	/**
	 *
...
/**
 * Check if a given object implements the PlayerPlatformStats interface.
 */
export function instanceOfPlayerPlatformStats(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function PlayerPlatformStatsFromJSON(json: any): PlayerPlatformStats {
	return PlayerPlatformStatsFromJSONTyped(json, false);
}

export function PlayerPlatformStatsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerPlatformStats {
...
export function PlayerPlatformStatsToJSON(value?: PlayerPlatformStats | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
