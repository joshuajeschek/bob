 ...
 * @export
 * @interface JunkerQueen
 */
export interface JunkerQueen {
	/**
	 * Statistics for "Assists" category
	 * @type {{ [key: string]: Assists; }}
	 * @memberof JunkerQueen
	 */
...
/**
 * Check if a given object implements the JunkerQueen interface.
 */
export function instanceOfJunkerQueen(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function JunkerQueenFromJSON(json: any): JunkerQueen {
	return JunkerQueenFromJSONTyped(json, false);
}

export function JunkerQueenFromJSONTyped(json: any, ignoreDiscriminator: boolean): JunkerQueen {
...
export function JunkerQueenToJSON(value?: JunkerQueen | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
