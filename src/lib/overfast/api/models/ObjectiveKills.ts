 ...
 * @export
 * @interface ObjectiveKills
 */
export interface ObjectiveKills {
	/**
	 * Label of the hero statistic
	 * @type {string}
	 * @memberof ObjectiveKills
	 */
	label: string;
	/**
...
/**
 * Check if a given object implements the ObjectiveKills interface.
 */
export function instanceOfObjectiveKills(value: object): boolean {
	let isInstance = true;
...
export function ObjectiveKillsFromJSON(json: any): ObjectiveKills {
	return ObjectiveKillsFromJSONTyped(json, false);
}

export function ObjectiveKillsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ObjectiveKills {
...
export function ObjectiveKillsToJSON(value?: ObjectiveKills | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
