...
/**
 * Check if a given object implements the Echo1 interface.
 */
export function instanceOfEcho1(value: object): boolean {
	let isInstance = true;
...
export function Echo1FromJSON(json: any): Echo1 {
	return Echo1FromJSONTyped(json, false);
}

export function Echo1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Echo1 {
...
export function Echo1ToJSON(value?: Echo1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
