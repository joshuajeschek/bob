...
/**
 * Check if a given object implements the Mei interface.
 */
export function instanceOfMei(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function MeiFromJSON(json: any): Mei {
	return MeiFromJSONTyped(json, false);
}

export function MeiFromJSONTyped(json: any, ignoreDiscriminator: boolean): Mei {
...
export function MeiToJSON(value?: Mei | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
