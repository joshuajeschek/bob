...
/**
 * Check if a given object implements the Mercy interface.
 */
export function instanceOfMercy(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function MercyFromJSON(json: any): Mercy {
	return MercyFromJSONTyped(json, false);
}

export function MercyFromJSONTyped(json: any, ignoreDiscriminator: boolean): Mercy {
...
export function MercyToJSON(value?: Mercy | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
