 ...
 * @export
 * @interface Lifeweaver
 */
export interface Lifeweaver {
	/**
...
/**
 * Check if a given object implements the Lifeweaver interface.
 */
export function instanceOfLifeweaver(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function LifeweaverFromJSON(json: any): Lifeweaver {
	return LifeweaverFromJSONTyped(json, false);
}

export function LifeweaverFromJSONTyped(json: any, ignoreDiscriminator: boolean): Lifeweaver {
...
export function LifeweaverToJSON(value?: Lifeweaver | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
