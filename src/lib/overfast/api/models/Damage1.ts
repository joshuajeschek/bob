...
/**
 * Check if a given object implements the Damage1 interface.
 */
export function instanceOfDamage1(value: object): boolean {
	let isInstance = true;
...
export function Damage1FromJSON(json: any): Damage1 {
	return Damage1FromJSONTyped(json, false);
}

export function Damage1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Damage1 {
...
export function Damage1ToJSON(value?: Damage1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
