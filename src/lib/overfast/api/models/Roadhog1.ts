...
/**
 * Check if a given object implements the Roadhog1 interface.
 */
export function instanceOfRoadhog1(value: object): boolean {
	let isInstance = true;
...
export function Roadhog1FromJSON(json: any): Roadhog1 {
	return Roadhog1FromJSONTyped(json, false);
}

export function Roadhog1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Roadhog1 {
...
export function Roadhog1ToJSON(value?: Roadhog1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
