...
/**
 * Check if a given object implements the Winston1 interface.
 */
export function instanceOfWinston1(value: object): boolean {
	let isInstance = true;
...
export function Winston1FromJSON(json: any): Winston1 {
	return Winston1FromJSONTyped(json, false);
}

export function Winston1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Winston1 {
...
export function Winston1ToJSON(value?: Winston1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
