...
/**
 * Check if a given object implements the Tank1 interface.
 */
export function instanceOfTank1(value: object): boolean {
	let isInstance = true;
...
export function Tank1FromJSON(json: any): Tank1 {
	return Tank1FromJSONTyped(json, false);
}

export function Tank1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Tank1 {
...
export function Tank1ToJSON(value?: Tank1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
