 ...
 * @export
 * @interface MultikillBest
 */
export interface MultikillBest {
	/**
	 * Label of the hero statistic
	 * @type {string}
	 * @memberof MultikillBest
	 */
	label: string;
	/**
...
/**
 * Check if a given object implements the MultikillBest interface.
 */
export function instanceOfMultikillBest(value: object): boolean {
	let isInstance = true;
...
export function MultikillBestFromJSON(json: any): MultikillBest {
	return MultikillBestFromJSONTyped(json, false);
}

export function MultikillBestFromJSONTyped(json: any, ignoreDiscriminator: boolean): MultikillBest {
...
export function MultikillBestToJSON(value?: MultikillBest | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
