...
/**
 * Check if a given object implements the Orisa1 interface.
 */
export function instanceOfOrisa1(value: object): boolean {
	let isInstance = true;
...
export function Orisa1FromJSON(json: any): Orisa1 {
	return Orisa1FromJSONTyped(json, false);
}

export function Orisa1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Orisa1 {
...
export function Orisa1ToJSON(value?: Orisa1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
