...
/**
 * Check if a given object implements the Doomfist1 interface.
 */
export function instanceOfDoomfist1(value: object): boolean {
	let isInstance = true;
...
export function Doomfist1FromJSON(json: any): Doomfist1 {
	return Doomfist1FromJSONTyped(json, false);
}

export function Doomfist1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Doomfist1 {
...
export function Doomfist1ToJSON(value?: Doomfist1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
