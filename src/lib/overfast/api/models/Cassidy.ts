...
/**
 * Check if a given object implements the Cassidy interface.
 */
export function instanceOfCassidy(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function CassidyFromJSON(json: any): Cassidy {
	return CassidyFromJSONTyped(json, false);
}

export function CassidyFromJSONTyped(json: any, ignoreDiscriminator: boolean): Cassidy {
...
export function CassidyToJSON(value?: Cassidy | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
