...
/**
 * Check if a given object implements the Reinhardt interface.
 */
export function instanceOfReinhardt(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function ReinhardtFromJSON(json: any): Reinhardt {
	return ReinhardtFromJSONTyped(json, false);
}

export function ReinhardtFromJSONTyped(json: any, ignoreDiscriminator: boolean): Reinhardt {
...
export function ReinhardtToJSON(value?: Reinhardt | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
