...
/**
 * Check if a given object implements the Dva interface.
 */
export function instanceOfDva(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function DvaFromJSON(json: any): Dva {
	return DvaFromJSONTyped(json, false);
}

export function DvaFromJSONTyped(json: any, ignoreDiscriminator: boolean): Dva {
...
export function DvaToJSON(value?: Dva | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
