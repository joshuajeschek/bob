...
/**
 * Check if a given object implements the Genji interface.
 */
export function instanceOfGenji(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function GenjiFromJSON(json: any): Genji {
	return GenjiFromJSONTyped(json, false);
}

export function GenjiFromJSONTyped(json: any, ignoreDiscriminator: boolean): Genji {
...
export function GenjiToJSON(value?: Genji | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
