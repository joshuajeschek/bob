...
/**
 * Check if a given object implements the WeaponAccuracy interface.
 */
export function instanceOfWeaponAccuracy(value: object): boolean {
	let isInstance = true;
...
export function WeaponAccuracyFromJSON(json: any): WeaponAccuracy {
	return WeaponAccuracyFromJSONTyped(json, false);
}

export function WeaponAccuracyFromJSONTyped(json: any, ignoreDiscriminator: boolean): WeaponAccuracy {
...
export function WeaponAccuracyToJSON(value?: WeaponAccuracy | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
