...
/**
 * Check if a given object implements the Baptiste interface.
 */
export function instanceOfBaptiste(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function BaptisteFromJSON(json: any): Baptiste {
	return BaptisteFromJSONTyped(json, false);
}

export function BaptisteFromJSONTyped(json: any, ignoreDiscriminator: boolean): Baptiste {
...
export function BaptisteToJSON(value?: Baptiste | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
