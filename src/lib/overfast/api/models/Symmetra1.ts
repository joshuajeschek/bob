...
/**
 * Check if a given object implements the Symmetra1 interface.
 */
export function instanceOfSymmetra1(value: object): boolean {
	let isInstance = true;
...
export function Symmetra1FromJSON(json: any): Symmetra1 {
	return Symmetra1FromJSONTyped(json, false);
}

export function Symmetra1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Symmetra1 {
...
export function Symmetra1ToJSON(value?: Symmetra1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
