...
/**
 * Check if a given object implements the Cassidy1 interface.
 */
export function instanceOfCassidy1(value: object): boolean {
	let isInstance = true;
...
export function Cassidy1FromJSON(json: any): Cassidy1 {
	return Cassidy1FromJSONTyped(json, false);
}

export function Cassidy1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Cassidy1 {
...
export function Cassidy1ToJSON(value?: Cassidy1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
