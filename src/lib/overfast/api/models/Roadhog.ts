...
/**
 * Check if a given object implements the Roadhog interface.
 */
export function instanceOfRoadhog(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function RoadhogFromJSON(json: any): Roadhog {
	return RoadhogFromJSONTyped(json, false);
}

export function RoadhogFromJSONTyped(json: any, ignoreDiscriminator: boolean): Roadhog {
...
export function RoadhogToJSON(value?: Roadhog | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
