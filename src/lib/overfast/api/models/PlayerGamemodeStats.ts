...
/**
 * Check if a given object implements the PlayerGamemodeStats interface.
 */
export function instanceOfPlayerGamemodeStats(value: object): boolean {
	let isInstance = true;
...
export function PlayerGamemodeStatsFromJSON(json: any): PlayerGamemodeStats {
	return PlayerGamemodeStatsFromJSONTyped(json, false);
}

export function PlayerGamemodeStatsFromJSONTyped(json: any, ignoreDiscriminator: boolean): PlayerGamemodeStats {
...
export function PlayerGamemodeStatsToJSON(value?: PlayerGamemodeStats | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
