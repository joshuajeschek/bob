...
/**
 * Check if a given object implements the Moira1 interface.
 */
export function instanceOfMoira1(value: object): boolean {
	let isInstance = true;
...
export function Moira1FromJSON(json: any): Moira1 {
	return Moira1FromJSONTyped(json, false);
}

export function Moira1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Moira1 {
...
export function Moira1ToJSON(value?: Moira1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
