...
/**
 * Check if a given object implements the Brigitte1 interface.
 */
export function instanceOfBrigitte1(value: object): boolean {
	let isInstance = true;
...
export function Brigitte1FromJSON(json: any): Brigitte1 {
	return Brigitte1FromJSONTyped(json, false);
}

export function Brigitte1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Brigitte1 {
...
export function Brigitte1ToJSON(value?: Brigitte1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
