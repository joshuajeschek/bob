...
/**
 * Check if a given object implements the Tracer1 interface.
 */
export function instanceOfTracer1(value: object): boolean {
	let isInstance = true;
...
export function Tracer1FromJSON(json: any): Tracer1 {
	return Tracer1FromJSONTyped(json, false);
}

export function Tracer1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Tracer1 {
...
export function Tracer1ToJSON(value?: Tracer1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
