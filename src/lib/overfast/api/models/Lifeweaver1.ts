 ...
 * @export
 * @interface Lifeweaver1
 */
export interface Lifeweaver1 {
	/**
	 * Number of games played
	 * @type {number}
	 * @memberof Lifeweaver1
	 */
	gamesPlayed: number;
	/**
	 * Number of games won
...
/**
 * Check if a given object implements the Lifeweaver1 interface.
 */
export function instanceOfLifeweaver1(value: object): boolean {
	let isInstance = true;
...
export function Lifeweaver1FromJSON(json: any): Lifeweaver1 {
	return Lifeweaver1FromJSONTyped(json, false);
}

export function Lifeweaver1FromJSONTyped(json: any, ignoreDiscriminator: boolean): Lifeweaver1 {
...
export function Lifeweaver1ToJSON(value?: Lifeweaver1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
