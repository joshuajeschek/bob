...
/**
 * Check if a given object implements the Ramattra interface.
 */
export function instanceOfRamattra(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function RamattraFromJSON(json: any): Ramattra {
	return RamattraFromJSONTyped(json, false);
}

export function RamattraFromJSONTyped(json: any, ignoreDiscriminator: boolean): Ramattra {
...
export function RamattraToJSON(value?: Ramattra | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
