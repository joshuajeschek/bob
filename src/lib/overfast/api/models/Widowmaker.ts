...
/**
 * Check if a given object implements the Widowmaker interface.
 */
export function instanceOfWidowmaker(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function WidowmakerFromJSON(json: any): Widowmaker {
	return WidowmakerFromJSONTyped(json, false);
}

export function WidowmakerFromJSONTyped(json: any, ignoreDiscriminator: boolean): Widowmaker {
...
export function WidowmakerToJSON(value?: Widowmaker | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
