...
/**
 * Check if a given object implements the Junkrat interface.
 */
export function instanceOfJunkrat(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function JunkratFromJSON(json: any): Junkrat {
	return JunkratFromJSONTyped(json, false);
}

export function JunkratFromJSONTyped(json: any, ignoreDiscriminator: boolean): Junkrat {
...
export function JunkratToJSON(value?: Junkrat | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
