...
/**
 * Check if a given object implements the Orisa interface.
 */
export function instanceOfOrisa(value: object): boolean {
	let isInstance = true;

	return isInstance;
}

export function OrisaFromJSON(json: any): Orisa {
	return OrisaFromJSONTyped(json, false);
}

export function OrisaFromJSONTyped(json: any, ignoreDiscriminator: boolean): Orisa {
...
export function OrisaToJSON(value?: Orisa | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
