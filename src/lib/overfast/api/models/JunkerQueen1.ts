 ...
 * @export
 * @interface JunkerQueen1
 */
export interface JunkerQueen1 {
	/**
	 * Number of games played
	 * @type {number}
	 * @memberof JunkerQueen1
	 */
	gamesPlayed: number;
	/**
	 * Number of games won
...
/**
 * Check if a given object implements the JunkerQueen1 interface.
 */
export function instanceOfJunkerQueen1(value: object): boolean {
	let isInstance = true;
...
export function JunkerQueen1FromJSON(json: any): JunkerQueen1 {
	return JunkerQueen1FromJSONTyped(json, false);
}

export function JunkerQueen1FromJSONTyped(json: any, ignoreDiscriminator: boolean): JunkerQueen1 {
...
export function JunkerQueen1ToJSON(value?: JunkerQueen1 | null): any {
	if (value === undefined) {
		return undefined;
	}
	if (value === null) {
